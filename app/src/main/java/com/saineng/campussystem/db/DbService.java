package com.saineng.campussystem.db;
...
import com.saineng.campussystem.App;
...
public class DbService {
     ...
     * 根据课程名查询
     */
    public Users queryNote(String name){


        return userDao.queryBuilder().where( UsersDao.Properties.User_id.eq(name)).build().unique();
    }
}